...
class Model(nn.Module):
    ...
    def __init__(self, configs, oti_pseudo_tokens, patch_len=16, stride=8):
        ...
        self.reprogramming_layer = ReprogrammingLayer(configs.d_model, configs.n_heads, self.d_ff, self.embedding_dim)
    ...
    def forward(self, x_enc, x_mark_enc, oti_pseudo_tokens, x_dec=None, x_mark_dec=None, template_oti_texts_shared=None, shared_token=None, return_ts_embeddings=False, return_attention_scores=False):
        ...
        enc_out, attention_scores = self.reprogramming_layer(enc_out, source_embeddings, source_embeddings)
        ...
        if return_ts_embeddings and return_attention_scores:
            return dec_out[:, -self.pred_len:, :], enc_out, attention_scores
        elif return_ts_embeddings:
            return dec_out[:, -self.pred_len:, :], enc_out
        elif return_attention_scores:
            return dec_out[:, -self.pred_len:, :], attention_scores
...
class ReprogrammingLayer(nn.Module):
    ...
    def forward(self, target_embedding, source_embedding, value_embedding):
        ...
        out, scores = self.reprogramming(target_embedding, source_embedding, value_embedding)
    ...
    def reprogramming(self, target_embedding, source_embedding, value_embedding):
        ...
        return reprogramming_embedding, scores
